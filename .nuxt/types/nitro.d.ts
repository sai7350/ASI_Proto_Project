...
declare global {
  ...
  const cachedEventHandler: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['cachedEventHandler']
  const cachedFunction: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['cachedFunction']
  ...
  const defineCachedEventHandler: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['defineCachedEventHandler']
  const defineCachedFunction: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['defineCachedFunction']
  const defineEventHandler: typeof import('h3')['defineEventHandler']
  const defineLazyEventHandler: typeof import('h3')['defineLazyEventHandler']
  const defineNitroPlugin: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['defineNitroPlugin']
  ...
  const defineRenderHandler: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['defineRenderHandler']
  ...
  const getRouteRules: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['getRouteRules']
  ...
  const nitroPlugin: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['nitroPlugin']
  ...
  const useNitroApp: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['useNitroApp']
  const useRuntimeConfig: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['useRuntimeConfig']
  const useSession: typeof import('h3')['useSession']
  const useStorage: typeof import('H:/Saapttrini Software Solution/Test_Project/SampleCode/node_modules/nitropack/dist/runtime')['useStorage']
