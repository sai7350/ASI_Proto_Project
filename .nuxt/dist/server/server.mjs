...
import { getCurrentInstance, reactive, toRef, isRef, inject, defineComponent, computed, ref, h, resolveComponent, version, nextTick, shallowRef, unref, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, createApp } from "vue";
...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/Map.45952285.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/dagdushethGanpati.12c22889.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/index.53dd76dc.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/lalMahal.35a96977.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/mahatmaPhuleMandai.f0d0ed77.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/secondpage.cb97cce3.js").then((m) => m.default || m)
  },
  {
    ...
    component: () => import("./_nuxt/shaniwarWada.8764a914.js").then((m) => m.default || m)
  }
];
...
const layouts = {
  custome: () => import("./_nuxt/custome.ac99a5ff.js").then((m) => m.default || m),
  default: () => import("./_nuxt/default.37d67f6d.js").then((m) => m.default || m)
};
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import("./_nuxt/error-component.14c468fd.js").then((r) => r.default || r));
    const nuxtApp = useNuxtApp();
